...
class DangoInsert(DangoFunction):
    ...
    def definition(self):
        return """\
insert(table, index, index_name, axis): Inserts an empty row or column at the specified index in the table. Other rows or columns will be move down or right.
Parameters:
